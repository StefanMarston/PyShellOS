This is a basic installation guide for PyShellOS.

1. download the PyShelOS directory (if you read this then you've already managed to do so)
2. open the /PyShellOS/ directory in your terminal.
