...
if __name__ == "__main__":
    OK = "[ " + f"\033[1;32m" + "OK " + "\033[0m" + "] "
    FAIL = "[ " + f"\033[31m" + "FAIL " + "\033[0m" + "] "
    WARN = "[ " + f"\033[1;33m" + "WARN " + "\033[0m" + "] "
    print("Booting PyShellOS...")
    time.sleep(1)
    print("\nPlease wait")
    time.sleep(0.2)
    ...
    time.sleep(random.randint(1, 2))
    print(OK + "Mounting /Kernel")
    time.sleep(random.randint(1, 3))
    print(OK + "Mounting /Boot")
    time.sleep(random.randint(1, 2))
    print(OK + "Mounting /Home")
    time.sleep(random.randint(1, 1))
    print(OK + "Extracting Kernel Level Files...")
    time.sleep(random.randint(1, 3))
    print(OK + "Initializing Storage...")
    time.sleep(random.randint(1, 2))
    print(OK + "Mounting /dev...")
    time.sleep(0.1)
    print(WARN + "Mounting /proc...")
    time.sleep(0.1)
    print(OK + "Mounting /sys...")
    time.sleep(0.1)
    print(FAIL + "Mounting /run...")
    time.sleep(0.1)
    print(OK + "Mounting /home...")
    time.sleep(0.1)
    print(OK + "Mounting /tmp...")
    time.sleep(0.1)
    print(OK + "Mounting /etc...")
    time.sleep(0.4)
    print(OK + "Mounting /var...")
    time.sleep(0.1)
    print(OK + "Mounting /opt...")
    time.sleep(0.1)
    print(WARN + "Logging in as root...")
    time.sleep(random.randint(1, 3))
    print(OK + "root executing /etc/..init/boot.py...")
    time.sleep(random.randint(1, 1))
    print(OK + "root executing /Kernel/main/kernel.py...")
    time.sleep(0.1)
    print(FAIL + "root disowning /Kernel...")
    time.sleep(random.randint(1, 1))
    print(OK + "root disowning /Boot...")
    time.sleep(random.randint(1, 2))
    print(OK + "Identifying Data")
    time.sleep(random.randint(1, 3))
    print(OK + "Loading Archives")
    time.sleep(random.randint(1, 3))
    print(OK + "Validating kernel Signature")
    time.sleep(random.randint(3, 8))
    print("\n" * 50)

    is_first_boot = check_first_boot()
    if is_first_boot:
        print("\n" + OK + "Detected first boot... This could take a moment...")
        time.sleep(0.3)
        print("\n" + OK + "Please wait")
        time.sleep(0.5)
        print("\n" * 50)
